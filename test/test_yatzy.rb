...
class YatzyTest < Test::Unit::TestCase
  def test_chance_scores
    assert_equal 15, Yatzy.chance(Dice.new(2, 3, 4, 5, 1).return_dice)
    assert_equal 16, Yatzy.chance(Dice.new(3, 3, 4, 5, 1).return_dice)
  end
  ...
  def test_four_of_a_kind_scores
    ...
    assert_equal 9, Yatzy.three_of_a_kind(Dice.new(3, 3, 3, 3, 3).return_dice, 4)
